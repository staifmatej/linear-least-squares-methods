...
class TestDataLoader(unittest.TestCase):
    ...
    def test_show_menu_invalid_then_valid_choice(self, mock_input):
        """Test show_menu with invalid inputs then valid choice."""
        result = self.data_loader.show_menu()
        self.assertEqual(result, 3)

    @patch('builtins.input', side_effect=['1,2', '3,4', 'done'])
    def test_input_2d_points_valid_input(self, mock_input):
    ...
    def test_input_2d_points_insufficient_points(self, mock_input):
    ...
    def test_input_multidimensional_valid_input(self, mock_input):
    ...
    def test_find_csv_files(self):
        ...
        csv_files = self.data_loader._find_csv_files()
    ...
    def test_csv_files_read_data_valid_file(self, mock_read_csv):
        ...
        with patch('builtins.input', side_effect=['y', 'x']):
            x_data, y_data = self.data_loader._csv_files_read_data('test.csv')
    ...
    def test_csv_files_read_data_empty_file(self, mock_read_csv):
        ...
        with self.assertRaises(ValueError):
            self.data_loader._csv_files_read_data('empty.csv')
    ...
    def test_csv_files_read_data_insufficient_rows(self, mock_read_csv):
        ...
        with self.assertRaises(ValueError):
            self.data_loader._csv_files_read_data('small.csv')
    ...
    def test_csv_files_read_data_insufficient_columns(self, mock_read_csv):
        ...
        with self.assertRaises(ValueError):
            self.data_loader._csv_files_read_data('narrow.csv')

    def test_csv_files_not_found_single_file(self):
        """Test _csv_files_not_found with single file."""
        csv_files = ['test.csv']
        with patch('builtins.input', return_value='1'):
            filename, _ = self.data_loader._csv_files_not_found(None, csv_files)
    ...
    def test_generate_synthetic_data_default_values(self, mock_input):
    ...
    @patch('builtins.input', side_effect=['1'])
    def test_use_example_dataset_house_prices(self, mock_input):
    ...
    def test_use_example_dataset_temperature(self, mock_input):
    ...
    def test_use_example_dataset_quadratic(self, mock_input):
    ...
    def test_use_example_dataset_sinusoidal(self, mock_input):
    ...
    def test_use_example_dataset_invalid_then_valid(self, mock_input):
    ...
    def test_get_data_choice_1(self, mock_input, mock_method):
        """Test get_data with choice 1."""
        mock_method.return_value = (np.array([[1], [2]]), np.array([3, 4]))
        x_data, y_data = self.data_loader.get_data()
        mock_method.assert_called_once()

    @patch.object(DataLoader, 'input_multidimensional')
    @patch('builtins.input', return_value='2')
    def test_get_data_choice_2(self, mock_input, mock_method):
    ...
    def test_get_data_choice_3(self, mock_input, mock_method):
    ...
    def test_get_data_choice_4(self, mock_input, mock_method):
    ...
    def test_get_data_choice_5(self, mock_input, mock_method):
